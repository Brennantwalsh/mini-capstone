Product.create!([
  ...
  {name: "Incredible Leather Coat", description: nil, price: "68.0", in_stock: nil, supplier_id: 1},
  ...
  {name: "Gorgeous Silk Computer", description: nil, price: "88.0", in_stock: nil, supplier_id: 1},
  {name: "Synergistic Linen Lamp", description: nil, price: "68.0", in_stock: nil, supplier_id: 1},
  {name: "Enormous Plastic Table", description: nil, price: "19.0", in_stock: nil, supplier_id: 1},
...
Image.create!([
  ...
  {url: "https://placehold.it/300x300.png", product_id: 4},
  ...
  {url: "https://placehold.it/300x300.png", product_id: 12},
