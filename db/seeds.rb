...
Product.create!([
  ...
  {name: "Gorgeous Silk Computer", description: "woo", price: "88.0", in_stock: nil, supplier_id: 1},
  {name: "Enormous Copper Lamp", description: "hello", price: "16.0", in_stock: nil, supplier_id: 2},
  {name: "Small Wooden Pants", description: "rude", price: "38.0", in_stock: nil, supplier_id: 1},
  {name: "Incredible Marble Lamp", description: "why", price: "54.0", in_stock: nil, supplier_id: 3},
  {name: "Lightweight Iron Table", description: "this", price: "95.0", in_stock: nil, supplier_id: 1},
  {name: "Heavy Duty Steel Computer", description: "is", price: "28.0", in_stock: nil, supplier_id: 1},
  {name: "Synergistic Linen Lamp", description: "fun", price: "68.0", in_stock: nil, supplier_id: 1},
  ...
  {name: "Practical Steel Keyboard", description: "oo", price: "16.0", in_stock: nil, supplier_id: 3},
  {name: "Enormous Paper Table", description: "oo", price: "15.0", in_stock: true, supplier_id: 1},
...
CartedProduct.create!([
  ...
  {user_id: 3, product_id: 2, quantity: 3, status: "purchased", order_id: 37},
  {user_id: 3, product_id: 2, quantity: 1, status: "purchased", order_id: 37},
...
Image.create!([
  ...
  {url: "http://www.retrousb.com/images/bk2big.jpg", product_id: 43},
